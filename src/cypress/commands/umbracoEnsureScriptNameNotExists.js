...
export default class UmbracoEnsureScriptNameNotExists extends CommandBase {
  _commandName = 'umbracoEnsureScriptNameNotExists';
      ...
      cy.request({
        ...
        if(searchBody.length > 0){
          ...
          if(partialViewId !== null){
            cy.request({
              method: 'POST',
              url: this._relativeBackOfficePath + '/backoffice/UmbracoApi/CodeFile/Delete?type=scripts&virtualPath=' + partialViewId,
